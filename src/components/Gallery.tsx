      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-4 text-gray-900">
            Our <span className="text-[#254f6c]">Gallery</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {galleryItems.map((item) => (
            <div
              key={item.id}
              className="group relative aspect-square bg-gradient-to-br from-[#254f6c]/10 to-[#254f6c]/5 rounded-2xl border border-[#254f6c]/20 overflow-hidden hover:border-[#254f6c]/50 transition-all duration-300 cursor-pointer shadow-sm hover:shadow-lg"
            >
              <div className="absolute inset-0 flex flex-col items-center justify-center">
                <Image className="text-[#254f6c] mb-4 group-hover:scale-110 transition-transform" size={48} />
        ...
        <div className="mt-16 text-center">
          ...
          <button className="border-2 border-[#254f6c] text-[#254f6c] px-8 py-3 rounded-full font-semibold hover:bg-[#254f6c] hover:text-white transition-all">
            @studionhair
          </button>
        </div>
      </div>
