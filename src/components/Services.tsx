      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <div
              key={index}
              className="group bg-gradient-to-br from-[#2B5F7F]/5 to-transparent p-8 rounded-2xl border border-[#2B5F7F]/20 hover:border-[#2B5F7F]/50 transition-all duration-300 hover:transform hover:scale-105"
            >
              ...
              <h3 className="text-2xl font-semibold mb-3 text-white group-hover:text-[#2B5F7F] transition-colors">
                {service.title}
              </h3>
              ...
              <div className="flex items-center justify-between pt-4 border-t border-[#2B5F7F]/20">
                ...
                <button className="text-sm text-gray-400 hover:text-[#2B5F7F] transition-colors">
                  Learn More →
                </button>
              </div>
            </div>
