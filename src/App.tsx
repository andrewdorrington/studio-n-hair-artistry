            ...
            <div className="flex items-center justify-between h-20">
              ...
              <div className="hidden md:block">
                <div className="ml-10 flex items-baseline space-x-8">
                  <button onClick={() => navigate('/')} className="text-[#F7F5F2] hover:text-[#C6B27C] transition-colors font-bold text-lg" style={{ fontFamily: "'Playfair Display', serif" }}>Home</button>
            ...
            {isMenuOpen && (
              <div className="md:hidden bg-[#2E2E2C] border-t border-[#B8ADA3]/30">
                <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                  <button onClick={() => navigate('/')} className="block w-full text-left px-3 py-2 hover:bg-[#F7F5F2]/10 transition-colors text-[#F7F5F2] hover:text-[#C6B27C] font-bold text-lg" style={{ fontFamily: "'Playfair Display', serif" }}>Home</button>
